    ...
    <body style="background-color: #f5f5f5;">
        ...
        <div class="w3-main w3-mobile" style="margin-left:280px;">
            ...
            <?php
                ...
                {
                    $y=date('Y')-1;
                    $sql = "SELECT app_id, verified, formsubmit FROM tybca".date('Y')." where app_id='".$appid."'";
                        ...
                        if($row['verified']==="0")
                        {
                            ...
                            else if($row['formsubmit']==="4")
                            {
                                echo '<div class="w3-container  w3-text-blue">
                                      ...
                                      <div class="w3-container  w3-text-blue">
                                        <h4>Subject Form of Semester 4 Submitted</h4>
                                      </div>';
                                include './StudentForm/tsbca1.php';
                            }
                            else
                            {
                                ...
                                echo '<div class="w3-container" style="padding:2%;">
                                        ...
                                        <div class="w3-panel w3-round-xlarge w3-border w3-border-blue">
                                            <p style="font-family: robotoregular;font-size:large;">Subject Form of Semester 5 Submitted <button type="button" name="action" onclick="showForm5();" class="w3-btn w3-white w3-border w3-border-blue w3-hover-blue w3-small w3-round-xlarge w3-margin-left">View Form</button> </p>
                                        </div>
                                        <div id="sem5" style="display:none;" class="w3-panel w3-round-xlarge w3-responsive w3-white w3-leftbar w3-rightbar w3-border-blue"></div> 
        ...
        <script>
                ...
                function showForm5()
                {
                    ...
                    xhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            document.getElementById("sem5").style.display = "block";
                            document.getElementById("sem5").innerHTML=this.responseText;
                        }
                    };
                    xhttp.open("POST", "viewForm.php", true);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
