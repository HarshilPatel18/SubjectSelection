    ...
    <body style="background-color: #f5f5f5;">
            ...
            <div class="w3-sidebar w3-bar-block w3-collapse w3-card-4 " style="width:280px;background-color: #fefefe;" id="mySidebar">
                ...
                <div class="w3-center" style="padding: 10px;">
                    ...
                    <a href="" class="w3-bar-item w3-button w3-hover-blue w3-round-large w3-margin-bottom w3-blue w3-text-white" style="font-family: robotoregular;padding-left: 30px;font-size: 16px;"><i class="material-icons">group</i>&nbsp;&nbsp; Batch</a>
            ...
            <div class="w3-main" style="margin-left:300px">
                ...
                <div>
                  ...
                  <div class="w3-container">
                      <h3 style="font-family: robotoregular;color: darkslategray">Batch</h3>
                  </div>
                </div>
                ...
                <div class="w3-container w3-margin w3-card-2 w3-white w3-round-xlarge w3-responsive w3-center" style="max-width: 50%">
                    <h4 class="w3-panel" style="font-family: robotoregular;color: darkslategray">FYBCA to SYBCA</h4>
                    <hr>
                    <a href="" class="w3-btn w3-white w3-round-xlarge w3-margin w3-border w3-border-blue">Move</a>
                </div>
                    
                
                <div class="w3-container w3-margin w3-card-2 w3-white w3-round-xlarge w3-responsive w3-center" style="max-width: 50%">
                    <h4 class="w3-panel" style="font-family: robotoregular;color: darkslategray">SYBCA to TYBCA</h4>
                    <hr>
                    <a href="" class="w3-btn w3-white w3-round-xlarge w3-margin w3-border w3-border-blue">Move</a>
                </div>
                
                <div class="w3-container w3-margin w3-card-2 w3-white w3-round-xlarge w3-responsive w3-center" style="max-width: 50%">
                    <h4 class="w3-panel" style="font-family: robotoregular;color: darkslategray">FYMSC to SYMSC</h4>
                    <hr>
                    <a href="" class="w3-btn w3-white w3-round-xlarge w3-margin w3-border w3-border-blue">Move</a>
                </div>
