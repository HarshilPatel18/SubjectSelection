...
<html>
    ...
    <body style="background-color: #f5f5f5;" onload="document.getElementById('fh1').click();document.getElementById('fh2').click();">
            ...
            <div class="w3-main" style="margin-left:300px">
                ...
                <div>
                  ...
                  <div class="w3-container">
                      <h3 style="font-family: robotoregular;color: darkslategray">Current Year Subjects - FYBCA </h3>
                  </div>
                </div>
                
               <!--Sem1-->
                <h5 class="w3-button w3-card w3-block w3-white w3-hover-blue w3-round-large" id="fh1" onclick="myFunction('Demo1')" style="font-family: robotoregular;">Semester 1</h5>
                            ...
                            if ($result->num_rows > 0)
                            {
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        //echo '<td><button type="button" name="update" onclick="updateSub(this);" class="w3-btn w3-blue w3-round-xlarge" course_code='.$row['course_code'].' courseType="fsbca-i">Update</button></td>';
                                        echo '<td><button type="button" name="delete" onclick="deleteSub(this);" class="w3-btn w3-red  w3-round-xxlarge" course_code='.$row['course_code'].' courseType="fsbca-i">Delete</button></td>';
                                        echo '</tr>';
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        echo '<td>'.$row['credits'].'</td>';
                                        //echo '<td><button type="button" name="update" onclick="updateSub(this);" class="w3-btn w3-blue w3-round-xlarge" course_code='.$row['course_code'].' courseType="fsbca-i">Update</button></td>';
                                        echo '<td><button type="button" name="delete" onclick="deleteSub(this);" class="w3-btn w3-red  w3-round-xlarge" course_code='.$row['course_code'].' courseType="fsbca-i">Delete</button></td>';
                                        echo '</tr>';
                                ...
                                <div id="adds1" class="w3-modal">
                                    ...
                                    <div class="w3-modal-content w3-animate-zoom w3-card-4 w3-round-large">
                                      <header class="w3-container w3-green"> 
                                        ...
                                        <h4>Add Subject Sem-1</h4>
                                      </header>
                                        <div class="w3-container">
                                        
                                            <select class="select" id="listsem1" onchange="fetchFSBCA1()" autocomplete="off">
                                                 <option selected disabled hidden >Select Course Type</option>
                                                <option value="fsbca1_core">Core Subjects</option>
                                        ...
                                        <footer class="w3-container w3-padding-24">
                                             <input type="button" onclick="addSub(this)" courseType="fsbca-i" class="w3-btn w3-round-xlarge w3-green" value="Add Subjects" />
                                        </footer>
      ...
      <!--Sem2-->
                <h5 class="w3-button w3-card w3-block w3-white w3-hover-blue w3-round-large" id="fh2" onclick="myFunction('Demo2')" style="font-family: robotoregular;margin-top: 40px;">Semester 2</h5>
                <div id="Demo2" class="w3-hide w3-center w3-container">
                        <?php
                            include '../DBConnection.php';
                            $sql="SELECT * FROM `fsbca-ii`";
                            $result = $conn->query($sql);
                            if ($result->num_rows > 0)
                            {
                                ...
                                //Core
                                echo '<h4 style="font-family: robotoregular;">Core Subjects</h4>';
                                $sql="SELECT bcasubjectlist.course_code,bcasubjectlist.course_name,bcasubjectlist.credits FROM bcasubjectlist INNER JOIN `fsbca-ii` ON bcasubjectlist.course_code=`fsbca-ii`.course_code WHERE bcasubjectlist.course_type=\"fsbca2_core\" ORDER BY bcasubjectlist.course_code ";
                                $result = $conn->query($sql);
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        echo '<td>'.$row['course_name'].'</td>';
                                        echo '<td>'.$row['credits'].'</td>';
                                        //echo '<td><button type="button" name="update" onclick="updateSub(this);" class="w3-btn w3-blue w3-round-xlarge" course_code='.$row['course_code'].' courseType="fsbca-ii">Update</button></td>';
                                        echo '<td><button type="button" name="delete" onclick="deleteSub(this);" class="w3-btn w3-red  w3-round-xxlarge" course_code='.$row['course_code'].' courseType="fsbca-ii">Delete</button></td>';
                                        echo '</tr>';
                                ...
                                //Electives
                                echo '<h4 style="font-family: robotoregular;">Elective Subjects</h4>';
                                $sql="SELECT bcasubjectlist.course_code,bcasubjectlist.course_name,bcasubjectlist.credits FROM bcasubjectlist INNER JOIN `fsbca-ii` ON bcasubjectlist.course_code=`fsbca-ii`.course_code WHERE bcasubjectlist.course_type=\"elective\" ORDER BY bcasubjectlist.course_code ";
                                $result = $conn->query($sql);
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        echo '<td>'.$row['credits'].'</td>';
                                        //echo '<td><button type="button" name="update" onclick="updateSub(this);" class="w3-btn w3-blue w3-round-xlarge" course_code='.$row['course_code'].' courseType="fsbca-i">Update</button></td>';
                                        echo '<td><button type="button" name="delete" onclick="deleteSub(this);" class="w3-btn w3-red  w3-round-xlarge" course_code='.$row['course_code'].' courseType="fsbca-ii">Delete</button></td>';
                                        echo '</tr>';
                                    ...
                                    <div class="w3-modal-content w3-animate-zoom w3-card-4 w3-round-large">
                                      <header class="w3-container w3-green"> 
                                        ...
                                        <div class="w3-container">
                                            ...
                                            <select class="select" id="listsem12" onchange="fetchFSBCA2()" autocomplete="off">
                                                 <option selected disabled hidden >Select Course Type</option>
                                                <option value="fsbca2_core">Core Subjects</option>
                                                <option value="elective">Electives</option>                                                 
                                            </select>
                                            <p id="fsbca2data"></p>
                                        ...
                                        <footer class="w3-container w3-padding-24">
                                             <input type="button" onclick="addSub(this)" courseType="fsbca-ii" class="w3-btn w3-round-xlarge w3-green" value="Add Subjects" />
                                        </footer>
            ...
            <script>
                function fetchFSBCA1()
                {
                    var s=document.getElementById("listsem1").value;
                    //alert(s);
                    var action="fetchfsbca1";
                    var xhttp;
                    ...
                    xhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            document.getElementById("fsbca1data").innerHTML = this.responseText;
                        }
                    };
                ...
                function fetchFSBCA2()
                {
                    var s=document.getElementById("listsem12").value;
                    //alert(s);
                    var action="fetchfsbca2";
                    var xhttp;
                            if(window.XMLHttpRequest){
                                xhttp = new XMLHttpRequest();
                            }
                    ...
                    xhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            document.getElementById("fsbca2data").innerHTML = this.responseText;
                        }
                    };
                    xhttp.open("POST", "actions.php", true);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
