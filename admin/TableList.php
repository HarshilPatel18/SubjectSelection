    ...
    <body style="background-color: #f5f5f5;">
            ...
            <div class="w3-sidebar w3-bar-block w3-collapse w3-card-4 " style="width:280px;background-color: #fefefe;" id="mySidebar">
                ...
                <div class="w3-center" style="padding: 10px;">
                    ...
                    <a href="" class="w3-bar-item w3-button w3-hover-blue w3-round-large w3-margin-bottom w3-blue w3-text-white" style="font-family: robotoregular;padding-left: 30px;font-size: 16px;"><i class="material-icons">content_paste</i>&nbsp;&nbsp; Table List</a>
                    <hr>
            ...
            <div class="w3-main" style="margin-left:300px">
                ...
                <div>
                  ...
                  <div class="w3-container">
                      <h3 style="font-family: robotoregular;color: darkslategray">Table List</h3>
                  </div>
                </div>
                ...
                <div class="w3-container">
                    ...
                    $sql="SHOW TABLES FROM subjectselection";
                    $result = $conn->query($sql);
                    if($result->num_rows > 0)
                    {
                        while($row = $result->fetch_assoc())
                        {
                            echo '<p class="w3-border w3-border-light-grey w3-round-xlarge w3-padding" style="font-size:medium;">'.$row['Tables_in_subjectselection'].'</p>';
                        }
                    }
